...
<button id="mapita" type="submit" class="btn btn-default" onclick="registrar_mapa()" data-lat="<?php echo $data_arr[0]; ?>" data-lng="<?php echo $data_arr[1]; ?>" data-direc="<?php echo $data_arr[2]; ?>">Registrar</button>
<?php
